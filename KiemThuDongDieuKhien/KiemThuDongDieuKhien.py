...
# Test cases
test_cases = [
    (-2, True),   # Số lượng sản phẩm ít hơn 10, khách hàng thường
    (12, False),  # Số lượng sản phẩm từ 10-20, khách hàng thường
    (22, True),  # Số lượng sản phẩm lớn hơn 20, khách hàng thường
    (2, True)  # Số lượng sản phẩm lớn hơn 20, khách hàng VIP
]

print("Kiểm thử C2")
# Kiểm thử các test case và in kết quả
for i, (quantity, customer_type) in enumerate(test_cases, start=1):
